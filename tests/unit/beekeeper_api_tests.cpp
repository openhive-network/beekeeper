// NOTE: This test file requires the full hive chain database fixture
// and can only be compiled when building with the hive repository.
// When building standalone beekeeper, these tests are skipped.
#if defined(IS_TEST_NET) && defined(HIVE_CHAIN_AVAILABLE)
