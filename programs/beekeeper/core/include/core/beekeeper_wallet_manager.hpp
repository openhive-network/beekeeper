...
public:
   ...
   */
  std::string create( const std::string& token, const std::string& wallet_name, const std::optional<std::string>& password, const bool is_temporary );
   ...
   */
  std::string create_session( const std::optional<std::string>& salt );
