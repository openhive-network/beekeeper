...
# Rewrites the crate version in Cargo.toml from the newest semver git tag,
# mirroring wax's rust/rust_generate_version.sh:
#   protected tag        -> <tag>                 (crates.io release)
#   protected branch     -> <tag>-stable.<time>   (prerelease)
#   anything else        -> <tag>-<time>          (dev prerelease)
